...
import 'controller/profil_d_zenleme_gonullu_controller.dart';

class ProfilDZenlemeGonulluScreen
    extends GetWidget<ProfilDZenlemeGonulluController> {
  const ProfilDZenlemeGonulluScreen({Key? key}) : super(key: key);
