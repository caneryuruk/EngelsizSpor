...
import 'controller/engelli_log_in_controller.dart';

// ignore_for_file: must_be_immutable
class EngelliLogInScreen extends GetWidget<EngelliLogInController> {
  EngelliLogInScreen({Key? key}) : super(key: key);
